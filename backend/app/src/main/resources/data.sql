...
INSERT INTO tournaments (id,name,tournament_type,is_private,number_of_players,random_bracket, enrollment_end,description)
       VALUES (1,'Turniej 1','LEAGUE',false,10,false, '2020-03-29', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec metus eros, tempor et tempor vel, pharetra lacinia ex.'),
              (2,'Turniej 2','MIXED',false,16,true,'2020-04-01','Quisque fermentum tortor nec nibh mollis egestas nec non risus.'),
              (3,'Turniej 3','LEAGUE',false,10,false, '2020-03-29', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec metus eros, tempor et tempor vel, pharetra lacinia ex.'),
              (4,'Turniej 4','MIXED',false,16,true,'2020-04-01','Quisque fermentum tortor nec nibh mollis egestas nec non risus.');
...
INSERT INTO tournaments_participants (tournament_id,participant_id)
       VALUES (1,2),
              (1,3);
