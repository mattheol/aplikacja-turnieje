...
INSERT INTO tournaments (id,name,tournament_type,is_private,number_of_players,random_bracket,description)
       VALUES (1,'Football tour','LEAGUE',true,10,false,null),
              (2,'CS tour','MIXED',true,16,true,null);
